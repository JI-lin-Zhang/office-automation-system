    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.gonggaobiaoti"
              placeholder="公告标题"
              clearable
              :readonly="ro.gonggaobiaoti"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.gonggaoleixing"
              placeholder="公告类型"
              clearable
              :readonly="ro.gonggaoleixing"
            ></el-input>
          </el-form-item>
          <div v-else>
