        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              /></el-button>
              <el-button
                v-if="isAuth('yuangong', '查看') && contents.tableBtnIcon == 0"
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
                >{{ contents.tableBtnFont == 1 ? "详情" : "" }}</el-button
              ...
              /></el-button>
              <el-button
                v-if="isAuth('yuangong', '修改') && contents.tableBtnIcon == 0"
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
                >{{ contents.tableBtnFont == 1 ? "修改" : "" }}</el-button
              ...
              /></el-button>
              <el-button
                v-if="isAuth('yuangong', '删除') && contents.tableBtnIcon == 0"
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
                >{{ contents.tableBtnFont == 1 ? "删除" : "" }}</el-button
...
export default {
  data() {
    return {
      ...
      contents: {
        searchBtnFontColor: "rgba(19, 20, 20, 1)",
        pagePosition: "1",
        inputFontSize: "14px",
        inputBorderRadius: "4px",
        tableBtnDelFontColor: "rgba(255, 73, 73, 1)",
        tableBtnIconPosition: "2",
        searchBtnHeight: "40px",
        inputIconColor: "#C0C4CC",
        searchBtnBorderRadius: "4px",
        tableStripe: true,
        btnAdAllWarnFontColor: "rgba(30, 136, 229, 1)",
        ...
        searchBtnBgColor: "rgba(38, 198, 218, 1)",
        inputTitleSize: "14px",
        btnAdAllBorderColor: "#DCDFE6",
        pageJumper: true,
        btnAdAllIconPosition: "1",
        searchBoxPosition: "1",
        tableBtnDetailFontColor: "rgba(38, 198, 218, 1)",
        tableBtnHeight: "40px",
        pagePager: true,
        ...
        btnAdAllFont: "1",
        btnAdAllDelFontColor: "rgba(255, 73, 73, 1)",
        tableBtnIcon: "1",
        btnAdAllHeight: "40px",
        ...
        pageStyle: false,
        pageTotal: true,
        btnAdAllAddFontColor: "rgba(38, 198, 218, 1)",
        tableBtnFont: "1",
        ...
        tableBtnEditFontColor: "rgba(30, 136, 229, 1)",
        tableAlign: "center",
      },
      layouts: "",
    };
